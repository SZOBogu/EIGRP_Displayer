...
class CalculatorIPTest {
    ...
    @Test
    void incrementAddressByInt() {
        IPAddress ip_address00 = calculator.incrementAddress(ip_address0, 255);
        IPAddress ip_address01 = calculator.incrementAddress(ip_address1, 2);
        IPAddress ip_address02 = calculator.incrementAddress(ip_address2, 257);
        IPAddress ip_address03 = calculator.incrementAddress(ip_address3, 10);

        IPAddress ip_address10 = new IPAddress(127,0,1,0);
        IPAddress ip_address11 = new IPAddress(0,0,0,1);
        IPAddress ip_address12 = new IPAddress(255,0,1,0);
        IPAddress ip_address13 = new IPAddress(100,255,255,9);
